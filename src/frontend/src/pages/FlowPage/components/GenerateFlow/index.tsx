  ...
  return (
    <Drawer direction="right" modal={false}>
      ...
      <DrawerContent className="left-[20%] bg-muted px-2 pb-2">
        <DrawerHeader className="!py-0 flex justify-between">
          <div>
        ...
        <div className="flex h-full w-full items-center justify-between">
          {/* min-h-[50vh] */}
          <div className="relative flex h-full w-full flex-col rounded-xl p-0 pt-4 lg:col-span-2 bg-white">
            {/* <Badge variant="outline" className="absolute right-3 top-3">
              Output
            </Badge> */}
            <p className="h-full flex-wrap whitespace-normal text-wrap  text-center min-h-10">
              ...
              <div className="relative flex h-full max-w-full flex-1 flex-col">
                ...
                <div className="flex w-full items-center">
                  <div className="dark:bg-token-main-surface-secondary flex w-full flex-col gap-1.5 rounded-[26px] border border-black bg-[#f4f4f4] p-1.5 transition-colors">
                    <div className="flex h-full flex-row items-end gap-1.5 md:gap-2 justify-center">
                      <div
                        className={
